...
class StudyhallController < ApplicationController
    # /studyhall
    def index
      ...
      @app_groups = current_user.study_sessions
    end

    # /studyhall/groups/:id
    def group
      ether = EtherpadLite.connect(:local, File.new('/home/etherpad-lite/APIKEY.txt'))
