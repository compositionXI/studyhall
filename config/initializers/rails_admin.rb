...
if File.basename($0) == 'rake'
  ...
  config.included_models = [ActivityMessage, Calendar, Comment, Contact, Course, Enrollment, Following, FratSorority, Instructor, Major, Note, Notebook, Message, MessageCopy, Offering, Post, School, Sport, SessionFile, SessionInvite, StaticPage, StudySession, User, Vote]
